...
// Líneas del campo en viewBox 100×100. El SVG padre se encarga del aspect
// ratio según FIELD_CONFIG[type].ratio. Aquí solo se dibujan las líneas
// reglamentarias en blanco roto, semi-transparentes para que destaquen sobre
// la superficie sin competir con jugadores y flechas.
export function FieldLines({ type }: FieldLinesProps) {
  const stroke = '#FFFCF1';
